export default function ProgressCircle({ percent }) {
  ...
  return (
      ...
      <div className="w-[108px] h-[108px] bg-blue-950 rounded-full flex justify-center items-center">
        <svg
          width="45px"
          height="60px"
          viewBox="0 0 102 100"
        ...
        <div className="text-white text-lg absolute">
          {percent ? (
            <div>
              {percent} <span className="absolute text-xs top-[5px]">%</span>
            </div>
          ) : (
            "NR"
          )}
