  ...
  return (
    <>
     ...
     >
      ...
      >
        <div
          className="w-[90%] h-[550px] bg-[#242424] text-white md:w-[560px] md:h-[600px] border border-[#e41212] shadow-3xl rounded-lg
        flex justify-center
        "
        >
          <div className="w-[90%] mt-8 flex flex-col">
            <button
              className="bg-[#e41212] text-[slate-100] w-full font-bold
            ...
            <h1 className="mt-4 mx-auto font-bold text-4xl text-slate-100">
              Create your account
            </h1>
            <input
